  ...
  return (
    <Box
      sx={{
        ...
        bgcolor: 'linear-gradient(135deg, #fceff9 0%, #e0f7fa 100%)',
        border: '2px solid #fff',
      }}
    >
      <Typography variant="h4" fontWeight="bold" color="#555">
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, mt: 2 }}>
        <Button
          variant="contained"
          sx={{ bgcolor: '#a0c4ff', '&:hover': { bgcolor: '#bdb2ff' } }}
        ...
        <Button
          variant="contained"
          sx={{ bgcolor: '#ffadad', '&:hover': { bgcolor: '#ffd6a5' } }}
